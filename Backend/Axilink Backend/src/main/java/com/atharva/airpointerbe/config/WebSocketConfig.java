...
@Configuration
    ...
    public ServletServerContainerFactoryBean createWebSocketContainer() {
        ...
        container.setMaxBinaryMessageBufferSize(5 * 1024 * 1024);    // 5
        return container;
    }
    ...
    public void configureWebSocketTransport(WebSocketTransportRegistration registry) {
        ...
        //registry.setMessageSizeLimit(10024 * 10024);
        // Message size limit in bytes
        // registry.setSendTimeLimit(20 * 1000);
         // Time limit for sending in milliseconds
        // registry.setSendBufferSizeLimit(10024 * 10024);
         // Buffer size limit in bytes


        registry
                .setMessageSizeLimit(5 * 1024 * 1024)           // 5 MB - Message size limit
                .setSendBufferSizeLimit(5 * 1024 * 1024)        // 5 MB - Send buffer size
                .setSendTimeLimit(20_000);                       // 20 seconds - Send timeout
    }
    }
